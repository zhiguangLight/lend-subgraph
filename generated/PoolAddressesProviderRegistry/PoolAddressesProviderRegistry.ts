...
export class PoolAddressesProviderRegistry extends ethereum.SmartContract {
  static bind(address: Address): PoolAddressesProviderRegistry {
    return new PoolAddressesProviderRegistry(
      "PoolAddressesProviderRegistry",
      address
    );
  }

  getAddressesProviderAddressById(id: BigInt): Address {
    let result = super.call(
      "getAddressesProviderAddressById",
      "getAddressesProviderAddressById(uint256):(address)",
  ...
  try_getAddressesProviderAddressById(
    id: BigInt
  ...
  getAddressesProviderIdByAddress(addressesProvider: Address): BigInt {
    let result = super.call(
      "getAddressesProviderIdByAddress",
      "getAddressesProviderIdByAddress(address):(uint256)",
      [ethereum.Value.fromAddress(addressesProvider)]
    );

    return result[0].toBigInt();
  }

  try_getAddressesProviderIdByAddress(
