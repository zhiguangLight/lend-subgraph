...
export class LendingContract__getConfigurationResultValue0Struct extends ethereum.Tuple {
  get data(): BigInt {
    return this[0].toBigInt();
  }
}

export class LendingContract__getReserveDataResultValue0Struct extends ethereum.Tuple {
  get configuration(): LendingContract__getReserveDataResultValue0ConfigurationStruct {
    return changetype<
      LendingContract__getReserveDataResultValue0ConfigurationStruct
    >(this[0].toTuple());
  }
...
export class LendingContract__getReserveDataResultValue0ConfigurationStruct extends ethereum.Tuple {
  get data(): BigInt {
    return this[0].toBigInt();
  }
}

export class LendingContract__getUserAccountDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class LendingContract__getUserConfigurationResultValue0Struct extends ethereum.Tuple {
  get data(): BigInt {
    return this[0].toBigInt();
  }
}

export class LendingContract extends ethereum.SmartContract {
  static bind(address: Address): LendingContract {
    return new LendingContract("LendingContract", address);
  }
  ...
  getConfiguration(
    asset: Address
  ): LendingContract__getConfigurationResultValue0Struct {
    let result = super.call(
      "getConfiguration",
    ...
    return changetype<LendingContract__getConfigurationResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getConfiguration(
    asset: Address
  ): ethereum.CallResult<LendingContract__getConfigurationResultValue0Struct> {
    let result = super.tryCall(
      "getConfiguration",
      "getConfiguration(address):((uint256))",
      [ethereum.Value.fromAddress(asset)]
    ...
    return ethereum.CallResult.fromValue(
      changetype<LendingContract__getConfigurationResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
  ...
  getReserveData(
    asset: Address
  ): LendingContract__getReserveDataResultValue0Struct {
    let result = super.call(
      "getReserveData",
    ...
    return changetype<LendingContract__getReserveDataResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getReserveData(
    asset: Address
  ): ethereum.CallResult<LendingContract__getReserveDataResultValue0Struct> {
    let result = super.tryCall(
      "getReserveData",
      "getReserveData(address):(((uint256),uint128,uint128,uint128,uint128,uint128,uint40,address,address,address,address,uint8))",
      [ethereum.Value.fromAddress(asset)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<LendingContract__getReserveDataResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
  ...
  getUserAccountData(user: Address): LendingContract__getUserAccountDataResult {
    let result = super.call(
      "getUserAccountData",
    ...
    return new LendingContract__getUserAccountDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getUserAccountData(
    user: Address
  ): ethereum.CallResult<LendingContract__getUserAccountDataResult> {
    let result = super.tryCall(
      "getUserAccountData",
      "getUserAccountData(address):(uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(user)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new LendingContract__getUserAccountDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getUserConfiguration(
    user: Address
  ): LendingContract__getUserConfigurationResultValue0Struct {
    let result = super.call(
      "getUserConfiguration",
    ...
    return changetype<LendingContract__getUserConfigurationResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  > {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<LendingContract__getUserConfigurationResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
